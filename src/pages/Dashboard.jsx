...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Calculate current streak (days with at least one habit completed)
      ...
      // Calculate success rate (completed habits vs total possible)
  ...
  const generateWeeklyProgress = (habits) => {
    ...
    habits.slice(0, 5).forEach(habit => {
      ...
      data.push({
        name: habit.title?.substring(0, 20) + (habit.title?.length > 20 ? '...' : ''),
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className={`p-3 rounded-xl ${isDark ? "bg-gray-700" : "bg-gray-100"}`}>
                <FireExtinguisher className={isDark ? "text-[#FF6B6B]" : "text-[#FF6B6B]"} size={24} />
              </div>
              <span className={`text-sm font-medium ${isDark ? "text-gray-400" : "text-gray-500"}`}>
                Current Streak
              </span>
                ...
                <div className="space-y-4">
                  {recentHabits.map((habit) => (
                    ...
                    >
                      ...
                      <Link
                        to={`/habit/${habit._id}`}
                        className={`px-4 py-2 rounded-lg text-sm font-medium ${isDark ? "bg-gray-600 hover:bg-gray-500 text-white" : "bg-gray-200 hover:bg-gray-300 text-gray-800"}`}
                      >
                        View
                      </Link>
                    </div>
          ...
          >
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-4">
                <Link
                  to="/dashboard/add-habit"
                  className={`flex flex-col items-center justify-center p-6 rounded-xl transition-all duration-300 ${isDark ? "bg-gray-700 hover:bg-gray-600" : "bg-gray-100 hover:bg-gray-200"}`}
                >
                  <PlusCircle size={32} className={`mb-3 ${isDark ? "text-[#9ECFD4]" : "text-[#016B61]"}`} />
                ...
                <Link
                  ...
                  className={`flex flex-col items-center justify-center p-6 rounded-xl transition-all duration-300 ${isDark ? "bg-gray-700 hover:bg-gray-600" : "bg-gray-100 hover:bg-gray-200"}`}
                >
                  <ListTodo size={32} className={`mb-3 ${isDark ? "text-[#9ECFD4]" : "text-[#016B61]"}`} />
                  <span className={`font-medium ${isDark ? "text-white" : "text-gray-900"}`}>
                    My Habits
                  </span>
                </Link>
                ...
                <Link
                  ...
                  className={`flex flex-col items-center justify-center p-6 rounded-xl transition-all duration-300 ${isDark ? "bg-gray-700 hover:bg-gray-600" : "bg-gray-100 hover:bg-gray-200"}`}
                >
                  <BarChart3 size={32} className={`mb-3 ${isDark ? "text-[#9ECFD4]" : "text-[#016B61]"}`} />
                  <span className={`font-medium ${isDark ? "text-white" : "text-gray-900"}`}>
                    Analytics
                  </span>
                </Link>
                ...
                <Link
                  ...
                  className={`flex flex-col items-center justify-center p-6 rounded-xl transition-all duration-300 ${isDark ? "bg-gray-700 hover:bg-gray-600" : "bg-gray-100 hover:bg-gray-200"}`}
                >
                  <Target size={32} className={`mb-3 ${isDark ? "text-[#9ECFD4]" : "text-[#016B61]"}`} />
                  <span className={`font-medium ${isDark ? "text-white" : "text-gray-900"}`}>
                    Explore
                  </span>
                </Link>
              ...
              <div className={`mt-6 p-4 rounded-xl ${isDark ? "bg-gray-700" : "bg-gray-100"}`}>
                <h4 className={`font-medium mb-2 ${isDark ? "text-white" : "text-gray-900"}`}>
                  Daily Tip
                </h4>
                <p className={`text-sm ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                  Consistency is key! Try to complete at least one habit every day to maintain your streak.
                </p>
              </div>
            </div>
          </motion.div>
