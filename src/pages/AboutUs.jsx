    ...
    >
      <div className="dmax-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          >
            We're on a mission to help people build lasting habits that lead to
            meaningful, positive change in their lives.
          </p>
        </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="space-y-4">
                ...
                <p className={isDark ? "text-gray-300" : "text-gray-600"}>
                  Founded in 2023 by a team of behavioral psychologists,
                  developers, and designers, we set out to create a solution
                  that combines scientific principles with beautiful, intuitive
                  design.
                </p>
                <p className={isDark ? "text-gray-300" : "text-gray-600"}>
                  Today, we've helped over 100,000 users build healthier, more
                  productive lives through consistent habit formation.
                </p>
              </div>
            </div>
            <div className="flex justify-center">
              <div className="relative w-64 h-64">
                <div className="absolute inset-0 bg-linear-to-br from-[#016B61] to-[#70B2B2] rounded-2xl transform rotate-6"></div>
                <div
                  className={`absolute inset-0 ${
                    isDark ? "bg-gray-800" : "bg-white"
                  } rounded-2xl shadow-xl flex items-center justify-center transform -rotate-6`}
                >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              ...
              >
                ...
                >
                  <div className="text-[#016B61]">{value.icon}</div>
                </div>
                <h3
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {teamMembers.map((member, index) => (
              ...
              >
                <div className="w-20 h-20 rounded-full bg-linear-to-br from-[#016B61] to-[#70B2B2] flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
                  {member.avatar}
                </div>
                <h3
