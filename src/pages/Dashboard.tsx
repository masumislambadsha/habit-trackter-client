...
type DashboardAnalytics = {
  dailyCompletion: Array<{ day: string; completions: number }>;
  categoryDistribution: Array<{ name: string; value: number; color: string }>;
  weeklyProgress: Array<{ name: string; progress: number }>;
};
...
const Dashboard = () => {
  ...
  const generateDailyCompletionData = (habits: Habit[]) => {
    const data = [];
    const today = new Date();
  ...
  const generateCategoryDistribution = (habits: Habit[]) => {
