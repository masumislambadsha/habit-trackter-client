  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Discover the truth behind the 21-day myth and what science says about building lasting habits.",
    ...
    },
    {
      ...
      excerpt:
        "Learn the morning routines that successful people swear by to boost productivity.",
    ...
    },
    {
      ...
      excerpt:
        "Practical strategies to overcome resistance and build habits that last a lifetime.",
    ...
    },
    {
      ...
      excerpt:
        "One user's journey from sedentary to marathon runner using habit stacking techniques.",
      author: "David Kim",
      date: "2024-02-28",
    ...
    },
    {
      ...
      excerpt:
        "How linking new habits to existing routines can accelerate your progress dramatically.",
      author: "Alex Johnson",
      date: "2024-02-20",
      readTime: "7 min read",
      category: "tips",
    ...
    },
    {
      ...
      excerpt:
        "Strategies to reduce screen time and build healthier relationships with technology.",
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          >
            Expert advice, success stories, and science-backed strategies to
            help you build lasting habits.
          </p>
        </motion.div>
                    ...
                    <div className="p-6">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          ...
                          <h3
                            className={`text-xl font-bold mb-2 group-hover:text-[#016B61] transition-colors ${
                              isDark ? "text-white" : "text-gray-900"
                            }`}
                          >
                            {post.title}
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              <div className="w-8 h-8 rounded-full bg-linear-to-br from-[#016B61] to-[#70B2B2] flex items-center justify-center text-white text-sm font-bold">
                                {post.author
                                  .split(" ")
                                  .map((n) => n[0])
                                  .join("")}
                            ...
                            <ArrowRight
                              className={
                                isDark
                                  ? "text-gray-400 group-hover:text-[#70B2B2]"
                                  : "text-gray-400 group-hover:text-[#016B61]"
                              }
                              size={20}
                            />
                          </div>
              ...
              {filteredPosts.map((post, index) => (
                ...
                >
                  <div className="p-6">
                    ...
                    <h3
                      className={`text-lg font-bold mb-3 group-hover:text-[#016B61] transition-colors ${
                        isDark ? "text-white" : "text-gray-900"
                      }`}
                    >
                      {post.title}
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {featuredAuthors.map((author, index) => (
              ...
              >
                <div className="w-16 h-16 rounded-full bg-linear-to-br from-[#016B61] to-[#70B2B2] flex items-center justify-center text-white text-xl font-bold mx-auto mb-4">
                  {author.avatar}
                </div>
                <h3
