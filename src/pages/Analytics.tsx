...
const Analytics = () => {
  ...
  const chartData =
    timeRange === "week" ? processWeeklyData() : processMonthlyData();
  ...
  const currentStreak =
    last30DaysData[last30DaysData.length - 1]?.completed || 0;

  const habitFrequency = habits
    .map((habit) => ({
      name:
        habit.title?.substring(0, 15) + (habit.title?.length > 15 ? "..." : ""),
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                >
                  ...
                  >
                    Your {completionRate}% completion rate shows{" "}
                    {completionRate > 70
                      ? "excellent"
                      : completionRate > 40
                      ? "good"
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    >
                      <Target
                        className={`${
                          isDark ? "text-[#70B2B2]" : "text-[#70B2B2]"
                        }`}
                        size={20}
                      />
                    </div>
                  ...
                  >
                    Your best streak is {maxStreak} days. Try to beat it by
                ...
                >
                  ...
                  >
                    Complete at least {Math.ceil(totalHabits * 0.7)} habits
                    daily to maintain a 70% success rate.
                  </p>
                </div>
                ...
                >
                  ...
                  >
                    {currentStreak > 3
                      ? "Great momentum!"
                      : "Build momentum by completing habits 3 days in a row."}
                  </p>
                </div>
              </div>
            </div>
