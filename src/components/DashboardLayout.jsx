...
const DashboardLayout = () => {
  ...
  return (
    <div className={`container mx-auto min-h-screen transition-colors duration-300 flex ${isDark ? "bg-gray-900" : "bg-gray-50"}`}>
      {/* Sidebar for Desktop */}
      <aside className={`hidden lg:flex flex-col w-64 transition-colors duration-300 ${isDark ? "bg-gray-800 border-r border-gray-700" : "bg-white border-r border-gray-200"}`}>
        <div className="p-6">
          <Link to="/" className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#016B61] to-[#70B2B2] flex items-center justify-center text-white font-bold text-xl">
              H
            </div>
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <div className={`fixed inset-y-0 left-0 w-64 ${isDark ? "bg-gray-800" : "bg-white"} shadow-xl`}>
            <div className="p-6">
      ...
      <div className="flex-1 flex flex-col">
        {/* Top Navbar */}
        <header className={`sticky top-0 z-30 border-b transition-colors duration-300 ${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"}`}>
          <div className="px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <button className={`p-2 rounded-xl ${isDark ? "hover:bg-gray-700" : "hover:bg-gray-100"}`}>
                  <Bell size={22} className={isDark ? "text-gray-300" : "text-gray-600"} />
                </button>
                ...
                <div className="relative">
                  ...
                  >
                    {user?.photoURL ? (
                      ...
                      <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-lg bg-gradient-to-br from-[#016B61] to-[#70B2B2]">
